...
namespace Pasukhi.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BusinessPrompts",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SystemPrompt = table.Column<string>(type: "text", nullable: false),
                    ToneDescription = table.Column<string>(type: "text", nullable: false),
                    EscalationMessage = table.Column<string>(type: "text", nullable: false),
                    MaxAiTokensPerDay = table.Column<int>(type: "integer", nullable: false),
                    AiConfidenceThreshold = table.Column<double>(type: "double precision", nullable: false),
                    FaqConfidenceThreshold = table.Column<double>(type: "double precision", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessPrompts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BusinessPrompts_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChannelConnections_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalInbound = table.Column<int>(type: "integer", nullable: false),
                    TotalOutbound = table.Column<int>(type: "integer", nullable: false),
                    FaqReplies = table.Column<int>(type: "integer", nullable: false),
                    RuleReplies = table.Column<int>(type: "integer", nullable: false),
                    AiReplies = table.Column<int>(type: "integer", nullable: false),
                    Escalations = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyMetrics_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FaqItems_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerProfilePictureUrl = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Conversations_ChannelConnections_ChannelConnectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiRejectedResponse = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Escalations_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalSenderId = table.Column<string>(type: "text", nullable: false),
                    SenderDisplayName = table.Column<string>(type: "text", nullable: true),
                    Source = table.Column<int>(type: "integer", nullable: false),
                    MatchedFaqItemId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    ExternalTimestamp = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutomationRules_BusinessId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessPrompts_BusinessId",
                table: "BusinessPrompts",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_BusinessSettings_BusinessId_Key",
                table: "BusinessSettings",
                columns: new[] { "BusinessId", "Key" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChannelConnections_BusinessId",
                table: "ChannelConnections",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_ChannelConnections_ExternalAccountId_ChannelType",
                table: "ChannelConnections",
                columns: new[] { "ExternalAccountId", "ChannelType" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_ChannelConnectionId",
                table: "Conversations",
                column: "ChannelConnectionId");

            migrationBuilder.CreateIndex(
                name: "IX_DailyMetrics_BusinessId",
                table: "DailyMetrics",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_Escalations_BusinessId",
                table: "Escalations",
                column: "BusinessId");
