  ...
  return (
    <div className="min-h-screen w-full bg-stone-50 px-6 py-12">
      <div className="mx-auto w-full max-w-[720px]">
        ...
        <h1 className="mt-6 text-[32px] font-semibold tracking-tight text-slate-950">Terms of Service</h1>
        ...
        <div className="mt-8 space-y-5 text-[14.5px] leading-relaxed text-slate-700">
          <p>
            By using Pasukhi you agree to these terms. Please read them carefully.
          </p>

          <h2 className="pt-4 text-[18px] font-semibold tracking-tight text-slate-950">Your account</h2>
          <p>
            You are responsible for safeguarding your credentials and for any activity that happens under your
            account. Notify us immediately of any unauthorized use.
          </p>

          <h2 className="pt-4 text-[18px] font-semibold tracking-tight text-slate-950">Acceptable use</h2>
          <p>
            Do not use Pasukhi to send spam, harass customers, or violate any laws. We reserve the right to
            suspend accounts that abuse the service.
          </p>

          <h2 className="pt-4 text-[18px] font-semibold tracking-tight text-slate-950">Changes</h2>
          <p>
            We may update these terms over time. We&apos;ll notify you of material changes via the dashboard or
            by email.
          </p>
